...
class Program
{
    public static void Main(string[] args)
    {
        ...
        {
            Console.WriteLine($"Biaya transfer = {fee} dan Total biaya = {amount + fee}");
        }
        if (data.lang.Equals("en"))
        {
        ...
        if ((confirm == data.confirmation.en) && data.lang == "en")
        {
            Console.WriteLine("The transfer is completed");
        }
        else if ((confirm == data.confirmation.id) && data.lang == "id")
        {
            Console.WriteLine("Proses Transaksi Berhasil");
        }
        else if ((confirm != data.confirmation.en) && data.lang == "en")
        {
